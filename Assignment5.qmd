...
Med mindre noe annet er spesifisert, er all deskriptiv data presentert som gjennomsnitt og standardavvik. Før studien ble det gjort en forhåndsbestemt utregning av utvalgsstørrelse, som viste at 40 deltakere ville være tilstrekkelig for å kunne oppdage forskjeller på omtrent 3 og 5 prosentpoeng for muskelens muskeltverrsnittsareal og maksimal styrke mellom de ulike volumforholdene med en ønsket statistisk styrke på 80%. Dette er basert på tall fra tidligere studier, som antar at forskjellene mellom volumforhold tilsvarer en effektstørrelse på mellom 0,19 og 0,24 (@ralston2017; @schoenfeld2016). For å se på hvordan de ulike volumforholdene påvirket muskelvekst og styrke, ble det benyttet lineære blandede modeller (LLM). De relative endringene fra baseline ble satt som den avhengige variabelen, mens antall sett som den uavhengige variabelen. Baseline variabelene, samt kjønn, ble brukt som kovarianter for å kontroller for deres potensielle effekt på muskelvekst og styrke.  
